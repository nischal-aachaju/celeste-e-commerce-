    ...
    <div>
      ...
      <div className=" h-200 w-full px-4 pt-8">
        <div className="flex justify-between ">
          ...
          <a className="text-[16px] w-fit text-[#d4af37] flex" href="">
            VIEW ALL <ArrowRight size={24} strokeWidth={1} />
          </a>
        </div>
        <p className="text-[12px]">
        ...
        <div className=" mt-10 w-full h-fit grid grid-cols-2 gap-4">
          {collections.map((e, idx) => {
            return <CollectionsSection data={e} key={idx} />;
          })}
        </div>
      </div>
    </div>
